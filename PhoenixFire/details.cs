...
namespace PhoenixFire
{
    public partial class details : Form
    {
        ...
        {
            //wheat +
            if (int.Parse(textBox18.Text) + int.Parse(textBox10.Text) + 1 > int.Parse(textBox9.Text) || int.Parse(textBox18.Text) > 19)
        ...
        {
            //kero +
            if (int.Parse(textBox20.Text) + int.Parse(textBox15.Text) + 1 > int.Parse(textBox14.Text) || int.Parse(textBox20.Text) > 4)
                MessageBox.Show("LIMIT CROSSES");
            else
            {
        ...
        {
            //rice +
            if (int.Parse(textBox3.Text) + int.Parse(textBox5.Text) + 1 > int.Parse(textBox4.Text) || int.Parse(textBox3.Text) > 19)
                MessageBox.Show("LIMIT CROSSES");
            else
            {
                variables.ricebuy += 1;
        ...
        {
            if (int.Parse(textBox3.Text) > 19)
            {
                //code
                MessageBox.Show("You can't purchase rice more than 20kg in a day.");
            }
        }
        ...
        private void textBox18_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.Parse(textBox18.Text) > 19)
            {
                //code
                MessageBox.Show("You can't purchase wheat more than 20kg in a day.");
            }
        ...
        private void textBox20_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.Parse(textBox20.Text) > 4)
            {
                //code
                MessageBox.Show("You can't purchase kerosene more than 5lit in a day.");
            }
        }
